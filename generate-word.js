const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, WidthType, HeadingLevel, AlignmentType, BorderStyle, ImageRun, convertInchesToTwip } = require('docx');
const fs = require('fs');
    ...
    sections: [
        ...
        // 正文
        {
            ...
            children: [
                ...
                createBulletParagraph('智能问答辅导：学生可随时向AI助教提问课程相关问题，系统自动识别知识点并给出专业解答，支持Markdown格式呈现，包含表格、代码块、公式等多种内容形式。'),
                createBulletParagraph('知识图谱导航：可视化展示课程核心概念及其关联关系，支持拖拽、缩放、节点高亮等交互操作，帮助学生建立系统化的知识体系。'),
                createBulletParagraph('个性化学习路径：基于学生的学习数据，自动推送学习计划、薄弱知识点突破建议、拓展阅读资源等，形成"教-学-评-辅"闭环。'),
                createBulletParagraph('实验代码辅助：提供8086汇编代码编辑器，支持语法高亮、智能调试、错误定位、修复建议、代码对比等功能，降低实验门槛。'),
                createBulletParagraph('自适应测试系统：支持按知识点和难度动态抽题，提供答题界面、成绩分析、薄弱点识别、解析查看等完整测试流程。'),
                createBulletParagraph('学情分析仪表盘：面向教师端，展示班级活跃度、高频问题排行、知识点掌握度柱状图、教学调整建议等，辅助教学决策。'),
                ...
                createBulletParagraph('数据层：融合课程标准、教学日历、超星题库、实验指导书四大数据源，构建课程专属知识库。'),
                createBulletParagraph('引擎层：部署AI对话引擎、个性化推荐算法、代码调试引擎三大核心引擎，支撑智能化服务。'),
                ...
                createBulletParagraph('回答内容自动关联教学日历、微课资源、相关知识点标签。'),
                ...
                createBulletParagraph('节点间关系用连线与文字标注，分类用颜色区分。'),
                ...
                createBulletParagraph('热门问题推荐'),
                createBulletParagraph('自然语言提问输入'),
                createBulletParagraph('AI逐字流式回答'),
                createBulletParagraph('Markdown内容渲染（表格、代码块、列表、加粗）'),
                createBulletParagraph('教学日历关联提示'),
                createBulletParagraph('微课资源推荐（视频、文档、练习）'),
                createBulletParagraph('相关知识点标签跳转'),
                createBulletParagraph('教学团队审核标识'),
                
                createNormalParagraph('2. 知识图谱模块', true),
                createBulletParagraph('D3.js力导向图画布'),
                createBulletParagraph('节点拖拽与缩放'),
                createBulletParagraph('节点点击高亮与关联显示'),
                createBulletParagraph('知识点详情面板'),
                createBulletParagraph('跨模块跳转（问答、练习）'),
                createBulletParagraph('学习路径建议'),
                createBulletParagraph('知识点分类图例'),
                
                createNormalParagraph('3. 学习路径模块', true),
                createBulletParagraph('学习数据统计卡片（时长、进度、题数、正确率等）'),
                createBulletParagraph('六维掌握度雷达图'),
                createBulletParagraph('章节进度条与薄弱点标注'),
                createBulletParagraph('本周学习计划推送'),
                createBulletParagraph('待完成任务列表'),
                createBulletParagraph('个性化推荐（薄弱点突破、拓展阅读、实验预习）'),
                createBulletParagraph('学习报告生成'),
                
                createNormalParagraph('4. 实验辅助模块', true),
                createBulletParagraph('实验项目列表'),
                createBulletParagraph('8086汇编代码编辑器'),
                createBulletParagraph('语法高亮（关键字、寄存器、数字、注释）'),
                createBulletParagraph('代码上传与重置'),
                createBulletParagraph('智能调试按钮'),
                createBulletParagraph('错误/警告定位与修复建议'),
                createBulletParagraph('代码对比视图（原始vs修复）'),
                createBulletParagraph('优化建议与质量评分'),
                
                createNormalParagraph('5. 自测系统模块', true),
                createBulletParagraph('知识点选择（12个知识点）'),
                createBulletParagraph('难度级别选择（简单、中等、困难）'),
                createBulletParagraph('题目数量设置（5-20题）'),
                createBulletParagraph('答题进度环形图'),
                createBulletParagraph('题目导航网格与收藏标记'),
                createBulletParagraph('单选/多选答题界面'),
                createBulletParagraph('成绩分析（正确数、正确率、用时）'),
                createBulletParagraph('薄弱知识点识别'),
                createBulletParagraph('重新抽题与解析查看'),
                
                createNormalParagraph('6. 教师端模块', true),
                createBulletParagraph('班级活跃度进度条'),
                createBulletParagraph('各班平均分与完成率对比'),
                createBulletParagraph('高频问题TOP10排行榜'),
                createBulletParagraph('问题趋势箭头显示'),
                ...
                createBulletParagraph('产品实践案例映射'),
                
                createNormalParagraph('8. 视频资源模块', true),
                createBulletParagraph('Bilibili视频链接解析'),
                createBulletParagraph('YouTube视频链接解析'),
                createBulletParagraph('视频分类筛选'),
                createBulletParagraph('在线iframe播放'),
                ...
                new Paragraph({ spacing: { before: 200 } }),
                createNumberedParagraph('课程深度融合：将课程标准、教学日历、题库、实验指导书四大数据源融合，构建课程专属知识库，而非通用AI助手。'),
                createNumberedParagraph('教-学-评-辅闭环：从知识点学习、练习测试、AI辅导、学习报告形成完整闭环，数据驱动个性化推荐。'),
                createNumberedParagraph('代码级实验支持：提供8086汇编代码编辑与智能调试功能，填补AI教育工具在实验环节的空白。'),
                createNumberedParagraph('多主题响应式设计：支持三种主题切换，暗色科技风格契合计算机课程特点，红色主题融入思政教育元素。'),
                createNumberedParagraph('隐私安全并重：学习数据本地存储，不用于模型训练，体现教育伦理责任。'),
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync(path.join(__dirname, 'docs', '计组智学教育智能体软件著作权申请材料.docx'), buffer);
    console.log('Word文档已生成：docs/计组智学教育智能体软件著作权申请材料.docx');
}).catch((err) => {
